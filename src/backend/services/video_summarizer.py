    ...
    contents = [
        {
            ...
            "parts": [
                {
                    "text": "Return the most important consequtive sentences of this transcript that talk about the most important topics of the video. Include as many sentences as needed to ensure that the full topic is completed but not more than 10 sentences. This is the transcript: " + transcript
                }
            ]
        }
    ]
